...
var file_payeet_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x22, 0x42, 0x0a, 0x0e, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x49, 0x44, 0x22, 0x39, 0x0a, 0x13, 0x52, 0x65, 0x66, 0x72, 0x65,
	...
	0x4f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65,
	...
	0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x98, 0x03, 0x0a, 0x06, 0x70,
	...
	0x0a, 0x0a, 0x47, 0x65, 0x74, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x73, 0x12, 0x19, 0x2e, 0x70,
	0x61, 0x79, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x70, 0x61, 0x79, 0x65, 0x65, 0x74,
...
var file_payeet_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_payeet_proto_goTypes = []interface{}{
	...
	(*AddFriendRequest)(nil),    // 11: payeet.AddFriendRequest
	(*RemoveFriendRequest)(nil), // 12: payeet.RemoveFriendRequest
	(*GetFriendsRequest)(nil),   // 13: payeet.GetFriendsRequest
	(*GetFriendsResponse)(nil),  // 14: payeet.GetFriendsResponse
}
var file_payeet_proto_depIdxs = []int32{
	...
	12, // 7: payeet.payeet.RemoveFriend:input_type -> payeet.RemoveFriendRequest
	13, // 8: payeet.payeet.GetFriends:input_type -> payeet.GetFriendsRequest
	8,  // 9: payeet.payeet_auth.Login:output_type -> payeet.LoginResponse
	8,  // 10: payeet.payeet_auth.RefreshToken:output_type -> payeet.LoginResponse
	1,  // 11: payeet.payeet_auth.Register:output_type -> payeet.StatusResponse
	10, // 12: payeet.payeet.GetUserInfo:output_type -> payeet.UserInfoResponse
	...
	14, // 17: payeet.payeet.GetFriends:output_type -> payeet.GetFriendsResponse
...
func (c *payeetClient) GetFriends(ctx context.Context, in *GetFriendsRequest, opts ...grpc.CallOption) (Payeet_GetFriendsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Payeet_serviceDesc.Streams[0], "/payeet.payeet/GetFriends", opts...)
	if err != nil {
		return nil, err
	}
